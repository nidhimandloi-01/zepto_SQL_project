...
git clone https://github.com/YOUR_USERNAME/zepto-sql-analysis.git
...
psql -d zepto_analysis -f 1_basic_query.sql
```
...
zepto-sql-analysis/
│
├── 1_basic_query.sql     ← Schema + Cleaning + EDA + 8 Business Queries
└── README.md
```
